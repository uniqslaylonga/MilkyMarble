...
async function getSalesOfficerDashboard(req, res) {
    try {
        ...
        let user = { fullName: 'Sales Officer', firstName: 'Officer', avatarSrc: '/customer/images/account.png' };
...
module.exports = { getSalesOfficerDashboard };